...
public final class Const {
    ...
    public final static String ATTR_USER_EMAIL = "userEmail";
    ...
    //存储服务状态
    public final static String PORT_STATUS = "port:status:";
    //监控的黑名单
    public final static String MONITOR_BLACK_LIST = "monitor:blacklist:";
